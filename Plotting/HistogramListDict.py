...
#                      "presel_nVtxNoPU" : ["nVtx"      , "presel_nVtxNoPU"  ,        [50,0,50], extraCuts, "%sevtWeight*muEffWeight*eleEffWeight*trigEffWeight*%s"%(extraCuts,btagWeightCategory[nBJets])],
                      ...
                      "rec_ptll"        : ["pt_ll"     , "rec_ptll"         ,     [200,20,220], extraCuts, ""],
